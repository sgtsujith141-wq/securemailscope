...
class WarningCode(StrEnum):
    ...
    TLS_RECORD_MALFORMED = "TLS_RECORD_MALFORMED"
    TLS_RECORD_ALIGNMENT_LOST = "TLS_RECORD_ALIGNMENT_LOST"
    TLS_RECORD_AMBIGUOUS = "TLS_RECORD_AMBIGUOUS"
    TLS_HANDSHAKE_MESSAGE_INCOMPLETE = "TLS_HANDSHAKE_MESSAGE_INCOMPLETE"
    TLS_HANDSHAKE_MALFORMED = "TLS_HANDSHAKE_MALFORMED"
    TLS_HANDSHAKE_ENCRYPTED = "TLS_HANDSHAKE_ENCRYPTED"
    TLS_EXTENSION_MALFORMED = "TLS_EXTENSION_MALFORMED"
    TLS_VERSION_UNDETERMINED = "TLS_VERSION_UNDETERMINED"
    TLS_ALERT_OBSERVED = "TLS_ALERT_OBSERVED"
    CERTIFICATE_PARSE_FAILED = "CERTIFICATE_PARSE_FAILED"
    CERTIFICATE_PARSER_UNAVAILABLE = "CERTIFICATE_PARSER_UNAVAILABLE"
    CERTIFICATE_CHAIN_VERIFICATION_UNAVAILABLE = "CERTIFICATE_CHAIN_VERIFICATION_UNAVAILABLE"
    CERTIFICATE_EXPIRED_AT_CAPTURE = "CERTIFICATE_EXPIRED_AT_CAPTURE"
    CERTIFICATE_NOT_YET_VALID_AT_CAPTURE = "CERTIFICATE_NOT_YET_VALID_AT_CAPTURE"
    ...
    LIMIT_TLS_RECORDS = "LIMIT_TLS_RECORDS"
    LIMIT_TLS_RECORD_BYTES = "LIMIT_TLS_RECORD_BYTES"
    LIMIT_TLS_HANDSHAKE_BYTES = "LIMIT_TLS_HANDSHAKE_BYTES"
    LIMIT_TLS_HANDSHAKE_MESSAGES = "LIMIT_TLS_HANDSHAKE_MESSAGES"
    LIMIT_CERTIFICATES = "LIMIT_CERTIFICATES"
    LIMIT_CERTIFICATE_BYTES = "LIMIT_CERTIFICATE_BYTES"
